...
public class CodeFromClass {
	...
	public static void main(String[] args) {
		try {
			...
			socket_dos.writeBytes("hello world! I'm client" + CRLF);
			...
			if (file.exists())
			{System.out.println("File exists, everything works fine!");}
				//server responds YES
			else
			{System.out.println("The file you claim does not exist");}
